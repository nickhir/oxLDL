...
i = c(1, 2)
density_scatter(
    df = pca_plot_df %>% mutate(low_libsize_dummy = ifelse(libsize < 1e6, "low libsize", "normal libsize")),
    x_variable = str_interp("PC${i[1]}"),
    y_variable = str_interp("PC${i[2]}"),
...
png(here("QC", "results", "imgs", "libsize_5e6_removed","association_heatmap.png"), res=300, width=9, height=5.5, units="in")
association_output$heatmap
dev.off()
