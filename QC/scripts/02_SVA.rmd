...
## **Introduction**
We saw in the script **01_rawQC.rmd**, that there are strong batch effects in our dataset which is not surprising.
...
The scripts for this analysis are now in the "Deprecated" folder.
...
# for creation see script **01_rawQC.rmd**
...
dummy_ <- parallel::mclapply(3:15, function(i) {
