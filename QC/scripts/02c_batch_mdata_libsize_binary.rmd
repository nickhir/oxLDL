...
Here we correct it using the metadata and add a covar which indicates high or low libsize
...
dds$libsize_bin <- ifelse(dds$libsize>5e6, "normal", "low")
...
### Conclusion
Honestly I barely notice any difference between the 2 datasets... 
This adjustment wont make a difference.
