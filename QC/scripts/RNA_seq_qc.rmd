...
```{r}
function(input_vector, include_n=FALSE) {
...
ggsave(combined_plot,
    filename = here("QC", "results", "imgs", "mdata_overview2.png"), 
...
keep <- filterByExpr(counts(dds0), group = mdata$sampletype)
dds0 <- dds0[keep,]
vsd_data <- vst(dds0)
...
png(here("QC", "results", "imgs", "association_heatmap_2.png"), res=350, width=9, height=5.5, units="in")
...
pca_plot_df[columns_to_plot] <- lapply(pca_plot_df[columns_to_plot], factor)
...
ggsave(
    plot = final_plot,
    filename = here("QC", "results", "imgs", "PCA_all_covariates_PC1_PC2_2.png"),
    dpi = 350,
    width = 20,
    height = 15,
)
...
ggsave(
    plot = final_plot,
    filename = here("QC", "results", "imgs", "PCA_all_covariates_boxplots_2.png"),
    dpi = 350,
    width = 20,
    height = 15,
)
...
# UMAP PLOTS #
##############
umap_plot_df[columns_to_plot] <- lapply(umap_plot_df[columns_to_plot], factor)
...
ggsave(
    plot = final_plot,
    filename = here("QC", "results", "imgs", "UMAP_all_covariates_2.png"),
    dpi = 350,
    width = 20,
    height = 15,
)
...
ggsave(
    plot = final_plot,
    filename = here("QC", "results", "imgs", "UMAP_all_covariates_boxplots_2.png"),
    dpi = 350,
    width = 20,
    height = 15,
)
