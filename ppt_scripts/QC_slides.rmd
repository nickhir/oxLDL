...
ggsave(
    plot = p,
    filename = here("ppt_scripts","imgs", "UMAP_batch_uncorrected.png"),
    dpi = 350, width = 4, height = 3,
    scale=2
)
...
# I would like to include the ORA i did because this is nice, then transition to mdata adjustment.
